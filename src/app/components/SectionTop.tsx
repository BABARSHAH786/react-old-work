...
<div className="w-[287px] h-[372px] ml-[100px]">
  ...
  {/* delete work */}
{/* <div className="w-[287px] h-[397px] mt-[-440px] ml-[417px]" > 
<Image className="pl-[14px]   " src={"/image 5.png"} alt="" width={450} height={340} />
</div>
<div className="w-[194px] h-[71px] mr-[900px] mt-[-40px]"> 
    <p className="text-[16px] mr-[] mt-[-40px] leading-[24px]">Granite dining table with dining chair</p>
    <p className="text-[24px] leading-[36px]">Rs. 25,000.00</p>
  </div> */}
 <div className="w-[1440px] h-[639px]  "> 
{/* <div className="flex">
    <div className="w-[983px] h-[799px] left-[36px]">
    <Image className="  " src={"/image.png"} alt="" width={850} height={640} />
    <div className="w-[331px] h-[205px] top-[200px] left-[100px] border-[1px]"> 
<p  className="w-[149px] h-[36px] top-[200px] right-[100px] border-[1px] font-medium size-[24px] leading-[36px]">New Arrivals</p>
<p className="w-[331px] h-[72px] font-bold size-[48px] leading-[72px]"> Asgaard sofa</p>
   <div className="w-[255px] h-[64px] top-[2827px] left-[1050px] border-[1px]  ">
    <p className="w-[106px] h-[30px] text-[20px] leading-[30px]  ">Order Now </p>
   </div>
...
<p className="w-[331px] h-[72px] font-black size-[48px] leading-[72px]"> Asgaard sofa</p>
   ...
   <Link className="relative left-[45px]  "  href="/Singleprod">

    <p className="w-[106px] h-[30px] text-[20px] border-black border-[1px] leading-[30px]  ">Order Now </p>
    </Link>
   </div>
...
<div className="w-[126px] h-[49px]  mt-[200px] text-center ">
<p  className="w-[126px] h-[30px] ml-[-560px] text-[20px] leading-[30px] underline ">View All Post</p>
...
<div className="w-[1440px] h-[450px] mt-[120px] ">
<div className="w-[454px] h-[202px] ml-[93px] rounderd-[50px] ">
  <div className="w-[454px] h-[120px] ml-[493px]  " >
    <p className="w-[454px] h-[90px] font-bold  text-[60px] leading-[90px] ">Our Instagram</p>
<p className="w-[297px] h-[30px]   text-[20px] leading-[30p] ">Follow our store on Instagram</p>
<div className="w-[255px] h-[64px]  rounderd-[50px] bg-[#FAF4F4]">
<p className="w-[92px] h-[30px] mr-[290px] mt-[30px] text-[20] leading-[30px]">Follow Us</p>
</div>
